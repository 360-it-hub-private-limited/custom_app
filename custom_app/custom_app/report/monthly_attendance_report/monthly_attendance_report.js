...
frappe.query_reports["Monthly Attendance Report"] = {
	...
	onload: function() {
		return  frappe.call({
			method: "custom_app.custom_app.report.monthly_attendance_report.monthly_attendance_report.get_attendance_years",
			callback: function(r) {
...
function cur_emp(emp_user){
	...
	if (emp_user){
		frappe.call({
			method: 'custom_app.custom_app.report.monthly_attendance_report.monthly_attendance_report.get_current_employee',
			args: {
				user_id: emp_user
			},
			callback: function (r) {
