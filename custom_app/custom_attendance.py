...
def apply_for_leave(name):
    try:
        ...
        cc_recipients=cc_recipients=leave_approvers(leave_application.employee)
...
def cancel_leave(name):
    try:
        ...
        if leave_application_doc!="Cancelled":
            ...
            cc_recipients=leave_approvers(leave_application_doc.employee)
